...
#
# trian_data_gen = train_image_generator.flow_from_directory(directory=train_dir,
#                                                            batch_size=batch_size,
#                                                            shuffle=True,
#                                                            target_size=(im_heights, im_width),
#                                                            class_mode='categorical')
# total_train = trian_data_gen.n
#
# # get class dict
# class_indices = trian_data_gen.class_indices
#
# # transform value and key of dict
# inverse_dict = dict((val, key) for key, val in class_indices.items())
# # write dict into json file
...
#                                                                        total_val))
#
# model = GoogLeNet(im_height=im_heights, im_width=im_width, class_num=5, aux_logits=True)
# model.summary()
#
# loss_object = tf.keras.losses.CategoricalCrossentropy(from_logits=False)
# optimizer = tf.keras.optimizers.Adam(learning_rate=0.0003)
...
# best_test_loss = 0.
# for epoch in range(epochs):
#     train_loss.reset_states()                 # clear historty info
...
#         model.save_weights("./save_weight/myGoogLeNet.h5")
